...
import { Linkedin, Clock, Hash, Briefcase, Image, Video } from 'lucide-react';
...
export const LinkedInPostOutput: React.FC<Props> = ({ data, compact = false }) => {
    if (!data) return null;
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: compact ? 12 : 16 }}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <Linkedin size={18} color="var(--accent-1)" />
                </div>
            ...
            {posts.map((post: any, idx: number) => {
                ...
                return (
                    <div key={idx} style={{
                        ...
                        {/* Caption — professional formatting */}
