...
import { Megaphone, FileText, MousePointerClick, Layout, Video, Zap, Music, Sparkles, ListChecks } from 'lucide-react';
...
export const TikTokAdsOutput: React.FC<Props> = ({ data, compact = false }) => {
    if (!data) return null;
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: compact ? 12 : 16 }}>
            ...
            <div style={{
                ...
                background: 'linear-gradient(135deg, rgba(0,0,0,0.12), rgba(124,92,255,0.06))',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: 1 }}>
                    <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-muted)', letterSpacing: '0.05em', textTransform: 'uppercase' }}>TikTok Ads</span>
            ...
            {variations.map((v: any, i: number) => (
                <div key={i} style={{
                    ...
                    <div style={{ padding: compact ? 12 : 16, display: 'flex', flexDirection: 'column', gap: 12 }}>
                        {/* Hook - prominent first line */}
                        {v.hook && (
                            <div style={{
                                padding: '10px 14px',
                                background: 'linear-gradient(135deg, rgba(0,0,0,0.08), rgba(124,92,255,0.04))',
                                ...
                                <Zap size={16} color="var(--accent-1)" style={{ marginTop: 2, flexShrink: 0 }} />
                                <div>
                                    <div style={{ fontSize: 11, color: 'var(--accent-1)', fontWeight: 700, marginBottom: 2, textTransform: 'uppercase', letterSpacing: '0.05em' }}>HOOK</div>
                        ...
                        {(v.script || v.body) && (
                            <div style={{ display: 'flex', gap: 10 }}>
                                ...
                                <div>
                                    <div style={{ fontSize: 11, color: 'var(--text-muted)', fontWeight: 600, marginBottom: 2 }}>SCRIPT</div>
                        ...
                        {v.sound_suggestion && (
                            <div style={{ display: 'flex', gap: 10 }}>
                                <Music size={16} color="var(--text-muted)" style={{ marginTop: 2, flexShrink: 0 }} />
                                <div>
                                    <div style={{ fontSize: 11, color: 'var(--text-muted)', fontWeight: 600, marginBottom: 2 }}>SOUND SUGGESTION</div>
                                    <div style={{
