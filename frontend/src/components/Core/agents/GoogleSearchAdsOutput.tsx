...
import { Megaphone, FileText, MousePointerClick, Layout, Search, Hash, Sparkles, ListChecks } from 'lucide-react';
...
export const GoogleSearchAdsOutput: React.FC<Props> = ({ data, compact = false }) => {
    if (!data) return null;
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: compact ? 12 : 16 }}>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: 1 }}>
                    <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-muted)', letterSpacing: '0.05em', textTransform: 'uppercase' }}>Google Search Ads</span>
            ...
            {variations.map((v: any, i: number) => {
                ...
                const descriptions = v.descriptions || (v.body ? [v.body] : []);
                                ...
                                <div style={{ display: 'flex', gap: 10 }}>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                                            {descriptions.map((d: string, idx: number) => (
                                                <div key={idx} style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                                                    <Hash size={12} color="var(--text-muted)" style={{ flexShrink: 0, marginTop: 2 }} />
